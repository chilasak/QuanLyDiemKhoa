              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="index.php?controllers=quanly&action=Edit_hocky&maHocky=<?php echo $value['ma_hk']; ?>" title="Sửa"><i class="fas fa-edit"></i> </a>
                      <a onclick="return confirm('Bạn có chắc chắn muốn xóa không..?')" href="index.php?controllers=quanly&action=Delete_hocky&maHocky=<?php echo $value['ma_hk']; ?>" title="Xóa"><i class="fas fa-trash-alt"> </i></a>
                    </td>
                  </tr>
                <?php } ?>
                </tbody>
